...
const mainContent = (function() {
	...
	const renderMainContent = function() {
		...
		for (const task in tasks) {
			...
			markup.appendChildren([taskHeaderLeftSide, taskHeaderRightSide], taskHeader);
			...
			if (currentTask.dueDate) {
				...
				const taskDueDate = markup.elementBuilder('p', 'task-due-date', dateStr);
			...
			if (project.title === 'today' || project.title === 'this week') {
				...
				const projectReminder = markup.elementBuilder('button', 'project-reminder', originalProject.title);
